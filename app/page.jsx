...
const Page = () => {
  return (
    <div>
      <div className='bg-indigo-700 p-[12rem_4rem_6rem] tablet:px-8 android:px-4 text-white *:text-center'>
        ...
        <p className='2xl:w-[70%] lg:w-[80%] android:w-full mx-auto text-xl mb-8 leading-snug tablet:text-lg'>Welcome to ANABEM Lifestyle Ltd., where innovation meets craftsmanship. We specialize in
        ...
        <div className='flex w-full gap-8 items-center justify-center'>
          <Link href='/services'
            className='bg-indigo-500 text-white w-[50%]  transition-all duration-200 ease-linear
